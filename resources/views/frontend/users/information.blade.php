  ...
  <body class="login-page">
    <main>
      <div class="login-block">
        ...
        <form action="/information/<?php  echo $information[0]->id; ?>" method="post">
        {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"><i class="ti-user"></i></span>
              <input type="text" id="firstname" name="firstname" class="form-control" placeholder="Họ đệm" readonly>
            </div>
          </div>
          <hr class="hr-xs">
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"><i class="ti-user"></i></span>
              <input type="text" id="lastname" name="lastname" class="form-control" placeholder="Tên" readonly>
            </div>
          </div>
          ...
          <button class="btn btn-primary btn-block" type="submit">Chỉnh sửa thông tin</button>
