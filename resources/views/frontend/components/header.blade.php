      ...
      <div class="container">
        ...
        <div class="pull-left">
          ...
          <div class="logo-wrapper">
            <a class="logo" href="/"><img src="{{url('/')}}/frontend/assets/img/logo.png" alt="logo"></a>
            <a class="logo-alt" href="/"><img src="{{url('/')}}/frontend/assets/img/logo-alt.png" alt="logo-alt"></a>
          </div>
        ...
        <div class="pull-right user-login">
          <a class="btn btn-sm btn-primary" href="/login">Đăng nhập</a> or <a href="/register">Đăng ký</a>
        </div>
        <!-- END User account -->
